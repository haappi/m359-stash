...
public class HelloController {
    ...
    @FXML
    protected TextField inputThing;
    @FXML
    ...
    protected void simplfyFraction() {
        Integer numerator =
                parseJOptionInput(
                        JOptionPane.showInputDialog("What is the numerator of the fraction? "),
                        Integer.class);
        Integer denominator =
                parseJOptionInput(
    ...
    protected void factorPairing() {
        Integer input =
                parseJOptionInput(
                        JOptionPane.showInputDialog("What number do you to get factor pairs for? "), Integer.class);
        if (input == null) {
            JOptionPane.showMessageDialog(null, "Invalid input");
            return;
        }
