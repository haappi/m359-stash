...
public class HelloController {
  ...
  @FXML protected TextField number1;
  @FXML protected TextField number2;
  ...
  protected void onButtonSlap() {
    ...
    String message =
        isMultipleOrNot
            ? toString(number1) + " is a multiple of " + toString(number2)
            : toString(number1) + " is not a multiple of " + toString(number2);
