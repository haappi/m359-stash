...
public class ViewItem extends NavigationDrawer.ViewItem {
    ...
    public ViewItem(String title, MaterialDesignIcon graphic, String viewName, ViewStackPolicy viewStackPolicy) {
    ...
    public ViewItem(String title, MaterialDesignIcon graphic, ViewEnums viewName, ViewStackPolicy viewStackPolicy) {
