...
public class SwitchButton extends GridPane {
    ...
    private void paintSwitch() {
        ...
        if (isOn.get()) {
            ...
            GridPane.setHalignment(lblDesc, HPos.CENTER);
            setStyle(
                    "-fx-background-radius: 30; -fx-background-color: #b0dea0; -fx-border-radius:"
                            + " 30;-fx-border-width:2; -fx-border-color: #ABABAB;-fx-effect:"
                            + " dropshadow(three-pass-box, rgba(0,0,0,0.2), 0.2, 0.0, 0.0, 1);");
        } else {
            add(knob, 0, 0);
            lblDesc.setText(falseValue);
            add(lblDesc, 1, 0);
            setStyle(
                    "-fx-background-radius: 30; -fx-background-color: #D6D6D6; -fx-border-radius:"
                            + " 30;-fx-border-width:2; -fx-border-color: #ABABAB;-fx-effect:"
                            + " dropshadow(three-pass-box, rgba(0,0,0,0.2), 0.2, 0.0, 0.0, 1);");
        }
    }
