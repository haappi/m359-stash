...
public class Person {
  ...
  public String changeStockOne(Integer amount) {
    ...
    if (amount < 0) {
      ...
      message =
          "You sold 1 share of " + stockOne.getName() + " for " + stockOne.getPriceFormatted();
    } else {
      if (wallet < stockOne.getPrice()) {
        ...
        wallet -= stockOne.getPrice();
        message =
            "You bought 1 share of " + stockOne.getName() + " for " + stockOne.getPriceFormatted();
      }
    }
  ...
  public String changeStockTwo(Integer amount) {
    ...
    if (amount < 0) {
      ...
      message =
          "You sold 1 share of " + stockTwo.getName() + " for " + stockTwo.getPriceFormatted();
    } else {
      if (wallet < stockTwo.getPrice()) {
        ...
        wallet -= stockTwo.getPrice();
        message =
            "You bought 1 share of " + stockTwo.getName() + " for " + stockTwo.getPriceFormatted();
      }
    }
