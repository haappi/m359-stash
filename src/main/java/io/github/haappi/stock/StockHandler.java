...
public class StockHandler {
  ...
  @FXML protected Button aIncrease;
  @FXML protected Button bIncrease;
  ...
  public StockHandler() {
    ...
    person =
        new Person(
            JOptionPane.showInputDialog("What is your name?"), (double) getRandomInteger(600, 700));
  ...
  protected void initialize() {
    ...
    int length =
        Math.max(
            stockA.getText().length(), stockB.getText().length()); // get the longest string length
